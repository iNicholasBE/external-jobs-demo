...
## What is this?
A Spring Boot demo app showcasing **JobRunr Pro 8.5 External Jobs** — jobs that are triggered by JobRunr but completed by an external system or a human decision.

## Tech stack
- Java 21, Spring Boot 3.5.6, Spring Data JDBC, Thymeleaf
...
- **In production, you'd use webhooks** instead of polling (→ motivation for JobRunr Cloud)
